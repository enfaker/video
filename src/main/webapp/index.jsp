    ...
    <div style="width: 100%;">
        <div class="layui-carousel lunbotuDiv" id="test1" lay-filter="test1">
            <div carousel-item>
                ...
                <div>
                    <a href="javascript:">
                        <img src="file/video/images/轮播图/网络迷踪.jpg" alt="网络迷踪" width="100%" height="400px">
                    </a>
                </div>
                <div>
                    <a href="javascript:">
                        <img src="file/video/images/轮播图/金刚川.jpg" alt="金刚川" width="100%" height="400px">
                    </a>
                </div>
                <div>
                    <a href="javascript:">
                        <img src="file/video/images/轮播图/好小子.jpg" alt="好小子" width="100%" height="400px">
                    </a>
                </div>
            </div>
            <a name="skip"></a>
